"""
This is OG Census Reporter and could use a careful look.
"""
...
def make_snake(string: str) -> str:
    return "_".join(
        re.sub(
            "([A-Z][a-z]+)",
            r" \1",
            re.sub("([A-Z]+)", r" \1", re.sub("[^a-zA-Z\d\s]", "", string)),
        ).split()
    ).lower()
...
def get_ratio(num1, num2, precision=2):
    ...
    if num1 and num2:
        return (
            round(round(float(num1) / float(num2), precision) * 100, 1) or None
        )
    return None
...
SUMLEV_CHOICES["Standard"] = [
    {
        ...
        "plural_name": "States",
        "summary_level": "040",
        "ancestor_sumlev_list": "010,020,030",
        "ancestor_options": "the United States",
    },
    {
        "name": "county",
        "plural_name": "Counties",
        "summary_level": "050",
        "ancestor_sumlev_list": "010,020,030,040",
        "ancestor_options": "the United States or a State",
    },
    {
        "name": "county subdivision",
        "plural_name": "County subdivisions",
        "summary_level": "060",
        "ancestor_sumlev_list": "010,020,030,040,050",
        "ancestor_options": "the United States, a State or County",
    },
    {
        "name": "place",
        "plural_name": "Places",
    ...
    },
    {
        ...
        "summary_level": "140",
        "ancestor_sumlev_list": "010,020,030,040,050,160",
        "ancestor_options": "the United States, a State, County or Place",
    },
    {
        "name": "block group",
        "plural_name": "Block groups",
        "summary_level": "150",
        "ancestor_sumlev_list": "010,020,030,040,050,140,160",
        "ancestor_options": "the United States, a State, County, Place or Census Tract",
    },
    {
        "name": "zip codes",
...
SUMLEV_CHOICES["Schools"] = [
    {
        ...
        "plural_name": "elementary school districts",
        "summary_level": "950",
        "ancestor_sumlev_list": "010,020,030,040,050",
        "ancestor_options": "the United States, a State or County",
    },
    {
        ...
        "plural_name": "secondary school districts",
        "summary_level": "960",
        "ancestor_sumlev_list": "010,020,030,040,050",
        "ancestor_options": "the United States, a State or County",
    },
    {
        ...
        "plural_name": "unified school districts",
        "summary_level": "970",
        "ancestor_sumlev_list": "010,020,030,040,050",
        "ancestor_options": "the United States, a State or County",
    },
...
ACS_RELEASES = {
    ...
    "acs2018_1yr": {
        "name": "ACS 2018 1-Year",
        "slug": "acs2018_1yr",
        "years": "2018",
    },
    "acs2017_5yr": {
        "name": "ACS 2017 5-Year",
        "slug": "acs2017_5yr",
        "years": "2013-2017",
    },
    "acs2017_1yr": {
        "name": "ACS 2017 1-Year",
        "slug": "acs2017_1yr",
        "years": "2017",
    },
    "acs2016_5yr": {
        "name": "ACS 2016 5-Year",
        "slug": "acs2016_5yr",
        "years": "2012-2016",
    },
    "acs2016_1yr": {
    ...
    "acs2011_1yr": {
        "name": "ACS 2011 1-Year",
        "slug": "acs2011_1yr",
        "years": "2011",
    },
    "acs2011_3yr": {
        "name": "ACS 2011 3-Year",
        "slug": "acs2011_3yr",
        "years": "2009-2011",
    },
    "acs2011_5yr": {
        "name": "ACS 2011 5-Year",
        "slug": "acs2011_5yr",
        "years": "2007-2011",
    },
    "acs2010_1yr": {
        "name": "ACS 2010 1-Year",
        "slug": "acs2010_1yr",
        "years": "2010",
    },
    "acs2010_3yr": {
        "name": "ACS 2010 3-Year",
        "slug": "acs2010_3yr",
        "years": "2008-2010",
    },
    "acs2010_5yr": {
        "name": "ACS 2010 5-Year",
        "slug": "acs2010_5yr",
        "years": "2006-2010",
    },
    "acs2009_1yr": {
        "name": "ACS 2009 1-Year",
        "slug": "acs2009_1yr",
        "years": "2009",
    },
    "acs2009_3yr": {
        "name": "ACS 2009 3-Year",
        "slug": "acs2009_3yr",
        "years": "2007-2009",
    },
    "acs2008_1yr": {
        "name": "ACS 2008 1-Year",
        "slug": "acs2008_1yr",
        "years": "2008",
    },
    "acs2008_3yr": {
        "name": "ACS 2008 3-Year",
        "slug": "acs2008_3yr",
        "years": "2006-2008",
    },
    "acs2007_1yr": {
        "name": "ACS 2007 1-Year",
        "slug": "acs2007_1yr",
        "years": "2007",
    },
    "acs2007_3yr": {
        "name": "ACS 2007 3-Year",
        "slug": "acs2007_3yr",
        "years": "2005-2007",
    },
}
